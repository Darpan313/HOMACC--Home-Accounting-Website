...
$email = "darpanpatel3131@gmail.com";
$reminder_details = "";
...
$result = mysql_query( "SELECT * FROM reminder WHERE reminder_date <= $trigger_date ORDER BY reminder_date ASC" );
...
mysql_query("DELETE FROM reminder WHERE reminder_date <= $trigger_date" );
}
?>
